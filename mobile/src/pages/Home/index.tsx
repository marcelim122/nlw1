...
/*
  ImageBackground: é uma forma de View poremq eu aceita uma imagem de background que é passado atrasves do source
  imageStyle: só pega a image de background
*/
...
const Home = () => {
  ...
  return (
    //caso o sistema for ios realiza o padding, caso contrario se mantem
    <KeyboardAvoidingView style={{flex:1}} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ImageBackground source={require('../../assets/home-background.png')} style={styles.container} imageStyle={{width:274, height:368}}>
        <View style={styles.main}>
          ...
          //a view em branco força o texto ser jogado para cima pelo keyboardavoidingview
          <View>
        ...
        <View style={styles.footer}>
          //onchangetext: ja consegue fazer o setUF durante a mudança do texto no input
